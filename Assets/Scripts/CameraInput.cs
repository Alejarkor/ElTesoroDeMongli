...
public class CameraInput : MonoBehaviour
{
    ...
    {       
        ...
        {            
            ...
            else
            {
                ...
                camController.ApplyAxisValues(Vector2.zero, Time.deltaTime);
            }
        }
        else
        {
            if (currentControlScheme == "Keyboard") 
            {
                ...
                if (Mouse.current.leftButton.isPressed)
                {
                    ...
                    camController.ApplyAxisValues(currentSmoothDelta * new Vector2(0.5f, 0.5f), Time.deltaTime);
    ...
    {
        camController.ApplyAxisValues(value.Get<Vector2>(), Time.deltaTime);        
    }
    ...
    private void ProcessInputTouchDeltaValue(Vector2 deltaValue)
    {
        ...
        camController.ApplyAxisValues(currentSmoothDelta * 0.1f, Time.deltaTime);
        newValue = true;        
    }
